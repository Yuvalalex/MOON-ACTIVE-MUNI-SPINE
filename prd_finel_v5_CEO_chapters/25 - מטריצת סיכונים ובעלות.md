...
%%{init: {
  ...
  'themeVariables': {
    ...
    'quadrantLabelColor': '#cbd5e1',
    'quadrantPointLabelColor': '#f8fafc',
    'quadrant1Fill': '#0b1329',
    'quadrant2Fill': '#3b0d11',
    'quadrant3Fill': '#090d16',
    'quadrant4Fill': '#1c1917',
...
quadrantChart
    ...
    quadrant-4 "Manage via SOPs"
    "Memory Tamper": [0.35, 0.95]
    "Thundering Herd": [0.65, 0.70]
    "Support Tickets Spike": [0.70, 0.40]
    "Ledger Double Spend": [0.20, 0.85]
    "App Store Rejection": [0.15, 0.90]
    "Client OOM": [0.25, 0.55]
    "LiveOps Sniping": [0.30, 0.65]
    "Economy Arbitrage": [0.40, 0.88]
```
