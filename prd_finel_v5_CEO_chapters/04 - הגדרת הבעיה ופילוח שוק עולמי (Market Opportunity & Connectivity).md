<!-- מקור: prd_finel_v5_CEO.md | פרק 4 מתוך 25 -->
...
flowchart TD
    ...
    subgraph GLOBAL_STATS ["🌍 <b>4.1 התפלגות הורדות עולמית: שווקי היעד של COIN MASTER</b>"]
        ...
        M1["🇮🇳 <b>הודו (Volume Market)</b><br/><br/><span style='font-size:26px;color:#38bdf8;'><b>24%</b></span><br/><span style='font-size:15px;color:#94a3b8;'>נפח משתמשים עצום • רשת לא יציבה</span>"]
        M2["🇧🇷 <b>ברזיל (Casual Hub)</b><br/><br/><span style='font-size:26px;color:#34d399;'><b>12%</b></span><br/><span style='font-size:15px;color:#94a3b8;'>שוק קז'ואל מרכזי • ניתוקי דרכים</span>"]
        M3["🇺🇸 <b>ארה''ב (Top Revenue)</b><br/><br/><span style='font-size:26px;color:#fbbf24;'><b>10%</b></span><br/><span style='font-size:15px;color:#94a3b8;'>LTV מקסימלי • טיסות ונסיעות עסקים</span>"]
        M4["🇲🇽 <b>מקסיקו (LATAM)</b><br/><br/><span style='font-size:26px;color:#f472b6;'><b>6%</b></span><br/><span style='font-size:15px;color:#94a3b8;'>שוק בצמיחה מהירה ב-LATAM</span>"]
        M5["🌐 <b>שאר העולם (Row)</b><br/><br/><span style='font-size:26px;color:#a855f7;'><b>48%</b></span><br/><span style='font-size:15px;color:#94a3b8;'>אירופה, אסיה-פסיפיק ועוד</span>"]

        M1 ~~~ M2 ~~~ M3 ~~~ M4 ~~~ M5
    end

    %% סגנון ראשי כהה
    style GLOBAL_STATS fill:#090d16,stroke:#38bdf8,stroke-width:3px,color:#38bdf8
    ...
    style M3 fill:#0f172a,stroke:#f59e0b,stroke-width:2px,color:#f8fafc
    style M4 fill:#0f172a,stroke:#ec4899,stroke-width:2px,color:#f8fafc
    style M5 fill:#0f172a,stroke:#8b5cf6,stroke-width:2px,color:#f8fafc
```
